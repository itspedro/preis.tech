...
Ok, o SEO é uma parte importante no desenvolvimento web mas isso eu já entendi mas como podemos fazer isso na prática??
...
A estrutura de pasta ficaria então assim:
